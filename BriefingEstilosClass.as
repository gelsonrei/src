package  
{
	 ...
	 * @author Gelson
	 */
	public class BriefingEstilosClass extends MovieClip 
	{
		
		private var myLoader:Loader;
		private var perfilId:int=0;
		
		public function BriefingEstilosClass(idPerfil:int) 
		{
			perfilId = idPerfil;
			if (stage) 	init();
		...
		private function init(e:Event = null):void 
		{
			...
			myLoader = new Loader();
			myLoader.load(new URLRequest(DefinesLoader.ASSETS_PATH+"BriefingEstilo"+perfilId+".swf"));
