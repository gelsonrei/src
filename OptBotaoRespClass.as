package  {
	...
	public class OptBotaoRespClass extends MovieClip {
		...
		{
			trace("OptBotaoResp CLICK " +dados.desc);
		}
		...
		{
			dados = dt;
			texto.text = correta?dados.resposta:dados.respErr;
			BTcontainerMC.height = texto.height;
		}
		
		public function setResp(vf: Boolean)
		{
			texto.text = vf?dados.resposta:dados.respErr;
			BTcontainerMC.height = texto.height;
		}
	
		public function OptBotaoRespClass(dt:StructPerguntaDLG, vf:Boolean) {
			correta = vf;
			setDados(dt);
			setOrdem("");
